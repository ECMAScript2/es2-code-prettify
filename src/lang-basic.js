...
PR.registerLangHandler(
    PR.createSimpleLexer(
        ...
        [ // fallthroughStylePatterns
          ...
          [PR.PR_COMMENT,       new RegExpCompat( "^REM[^\\r\\n]*" ), null],
          [PR.PR_KEYWORD,       new RegExpCompat( "^\\b(?:AND|CLOSE|CLR|CMD|CONT|DATA|DEF ?FN|DIM|END|FOR|GET|GOSUB|GOTO|IF|INPUT|LET|LIST|LOAD|NEW|NEXT|NOT|ON|OPEN|OR|POKE|PRINT|READ|RESTORE|RETURN|RUN|SAVE|STEP|STOP|SYS|THEN|TO|VERIFY|WAIT)\\b" ), null],
          [PR.PR_PLAIN,         new RegExpCompat( "^[A-Z][A-Z0-9]?(?:\\$|%)?", 'i' ), null],
          // Literals .0, 0, 0.0 0E13
          [PR.PR_LITERAL,       new RegExpCompat(  "^(?:\\d+(?:\\.\\d*)?|\\.\\d+)(?:e[+\\-]?\\d+)?", 'i' ),  null, '0123456789'],
