...
PR.registerLangHandler(
    PR.createSimpleLexer(
        ...
        [ // fallthroughStylePatterns
          ...
          [PR.PR_COMMENT,       new RegExpCompat( "^\\(\\*[\\s\\S]*?(?:\\*\\)|$)|^\\{[\\s\\S]*?(?:\\}|$)" ), null],
          [PR.PR_KEYWORD,       new RegExpCompat( "^(?:ABSOLUTE|AND|ARRAY|ASM|ASSEMBLER|BEGIN|CASE|CONST|CONSTRUCTOR|DESTRUCTOR|DIV|DO|DOWNTO|ELSE|END|EXTERNAL|FOR|FORWARD|FUNCTION|GOTO|IF|IMPLEMENTATION|IN|INLINE|INTERFACE|INTERRUPT|LABEL|MOD|NOT|OBJECT|OF|OR|PACKED|PROCEDURE|PROGRAM|RECORD|REPEAT|SET|SHL|SHR|THEN|TO|TYPE|UNIT|UNTIL|USES|VAR|VIRTUAL|WHILE|WITH|XOR)\\b", 'i' ), null],
          [PR.PR_LITERAL,       new RegExpCompat( "^(?:true|false|self|nil)", 'i' ), null],
          [PR.PR_PLAIN,         new RegExpCompat( "^[a-z][a-z0-9]*", 'i' ), null],
          // Literals .0, 0, 0.0 0E13
          [PR.PR_LITERAL,       new RegExpCompat( "^(?:\\$[a-f0-9]+|(?:\\d+(?:\\.\\d*)?|\\.\\d+)(?:e[+\\-]?\\d+)?)", 'i' ),  null, '0123456789'],
