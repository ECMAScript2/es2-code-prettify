...
// The call to registerLangHandler is quoted so that Closure Compiler
...
registerLangHandler(
    createSimpleLexer(
        ...
        [
         ...
         [PR_STRING,
          RegExpProxy( "^\\'(?:[^\\n\\r\\f\\\\\\']|\\\\(?:\\r\\n?|\\n|\\f)|\\\\[\\s\\S])*\\'" ), null],
         ['lang-css-str', RegExpProxy( "^url\\(([^\\)\\\"\\']+)\\)", 'i' )],
         [PR_KEYWORD,
          RegExpProxy(  "^(?:url|rgb|\\!important|@import|@page|@media|@charset|inherit)(?=[^\\-\\w]|$)", 'i' ),
          null],
         // A property name -- an identifier followed by a colon.
         ['lang-css-kw', RegExpProxy( "^(-?(?:[_a-z]|(?:\\\\[0-9a-f]+ ?))(?:[_a-z0-9\\-]|\\\\(?:\\\\[0-9a-f]+ ?))*)\\s*:", 'i' )],
         // A C style block comment.  The <comment> production.
         [PR_COMMENT, RegExpProxy( "^\\/\\*[^*]*\\*+(?:[^\\/*][^*]*\\*+)*\\/" )],
         // Escaping text spans
         [PR_COMMENT, RegExpProxy( "^(?:<!--|-->)" )],
         // A number possibly containing a suffix.
         [PR_LITERAL, RegExpProxy( "^(?:\\d+|\\d*\\.\\d+)(?:%|[a-z]+)?", 'i' )],
         // A hex color
         [PR_LITERAL, RegExpProxy( "^#(?:[0-9a-f]{3}){1,2}\\b", 'i' ) ],
         // An identifier
         [PR_PLAIN,
          RegExpProxy( "^-?(?:[_a-z]|(?:\\\\[\\da-f]+ ?))(?:[_a-z\\d\\-]|\\\\(?:\\\\[\\da-f]+ ?))*", 'i' )],
         // A run of punctuation
         [PR_PUNCTUATION, RegExpProxy( "^[^\\s\\w\\'\\\"]+" )]
        ]),
    ['css']);
