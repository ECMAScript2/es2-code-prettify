...
PR['registerLangHandler'](
    PR['createSimpleLexer'](
        ...
        [
         // variable.llvm
         [PR['PR_PLAIN'],       new RegExpCompat( "^[%@!](?:[-a-zA-Z$._][-a-zA-Z$._0-9]*|\\d+)" )],
         ...
         [PR['PR_KEYWORD'],     new RegExpCompat( "^[A-Za-z_][0-9A-Za-z_]*" ), null],

         // constant.numeric.float.llvm
         [PR['PR_LITERAL'],     new RegExpCompat( "^\\d+\\.\\d+" )],
         
         // constant.numeric.integer.llvm
         [PR['PR_LITERAL'],     new RegExpCompat( "^(?:\\d+|0[xX][a-fA-F0-9]+)" )],
