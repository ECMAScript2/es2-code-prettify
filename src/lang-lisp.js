...
PR['registerLangHandler'](
    PR['createSimpleLexer'](
        ...
        [
         [PR['PR_KEYWORD'],     new RegExpCompat( "^(?:block|c[ad]+r|catch|con[ds]|def(?:ine|un)|do|eq|eql|equal|equalp|eval-when|flet|format|go|if|labels|lambda|let|load-time-value|locally|macrolet|multiple-value-call|nil|progn|progv|quote|require|return-from|setq|symbol-macrolet|t|tagbody|the|throw|unwind)\\b" ), null],
         [PR['PR_LITERAL'],
