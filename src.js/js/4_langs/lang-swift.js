...
registerLangHandler(
    createSimpleLexer(
        ...
        [
          ...
          [PR_LITERAL,              RegExpProxy( "^(?:(?:0x[\\da-fA-F][\\da-fA-F_]*\\.[\\da-fA-F][\\da-fA-F_]*[pP]?)|(?:\\d[\\d_]*\\.\\d[\\d_]*[eE]?))[+-]?\\d[\\d_]*" ), null],
          //integer literals
          [PR_LITERAL,              RegExpProxy( "^-?(?:(?:0(?:(?:b[01][01_]*)|(?:o[0-7][0-7_]*)|(?:x[\\da-fA-F][\\da-fA-F_]*)))|(?:\\d[\\d_]*))" ), null],
          //some other literals
          [PR_LITERAL,              RegExpProxy( "^(?:_|Any|true|false|nil)\\b" ), null],
          //keywords
          ...
          //punctuation
          [PR_PUNCTUATION,          RegExpProxy( "^<<=|<=|<<|>>=|>=|>>|===|==|\\.\\.\\.|&&=|\\.\\.<|!==|!=|&=|~=|~|\\(|\\)|\\[|\\]|{|}|@|#|;|\\.|,|:|\\|\\|=|\\?\\?|\\|\\||&&|&\\*|&\\+|&-|&=|\\+=|-=|\\/=|\\*=|\\^=|%=|\\|=|->|`|==|\\+\\+|--|\\/|\\+|!|\\*|%|<|>|&|\\||\\^|\\?|=|-|_" ), null],
          [PR_TYPE,                 RegExpProxy( "^\\b(?:[@_]?[A-Z]+[a-z][A-Za-z_$@0-9]*|\\w+_t\\b)" ), null]   //borrowing the type regex given by the main program for C-family languages
        ]),
    ['swift']); 
