...
function createSimpleLexer( shortcutStylePatterns, fallthroughStylePatterns ){
    ...
    return getSimpleLexerClosure( shortcuts, combinePrefixPatterns( allRegexs ), fallthroughStylePatterns );
};
 ...
 */
function getSimpleLexerClosure( shortcuts, tokenizer, fallthroughStylePatterns ){
    function simpleLexer( job ){
        decorate( job, shortcuts, tokenizer, fallthroughStylePatterns, simpleLexer );
    };
    return simpleLexer;
};
 ...
 * @param {RegExp|RegExpCompat} tokenizer 
 * @param {Array.<StylePattern>} fallthroughStylePatterns 
 * @param {function (JobT)} simpleLexer
 */
function decorate( job, shortcuts, tokenizer, fallthroughStylePatterns, simpleLexer ){
