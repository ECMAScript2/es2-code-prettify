...
registerLangHandler(
    createSimpleLexer(
        [
         ...
         [PR_STRING,      RegExpProxy( "^(?:[\\\"\\u201C\\u201D](?:[^\\\"\\u201C\\u201D]|[\\\"\\u201C\\u201D]{2})(?:[\\\"\\u201C\\u201D]c|$)|[\\\"\\u201C\\u201D](?:[^\\\"\\u201C\\u201D]|[\\\"\\u201C\\u201D]{2})*(?:[\\\"\\u201C\\u201D]|$))", 'i' ), null,
          '"\u201C\u201D'],
        ...
        [
         ...
         [PR_COMMENT, RegExpProxy( "^REM\\b[^\\r\\n\\u2028\\u2029]*", 'i' )],
         // A boolean, numeric, or date literal.
         [PR_LITERAL,
          RegExpProxy( "^(?:True\\b|False\\b|Nothing\\b|\\d+(?:E[+\\-]?\\d+[FRD]?|[FRDSIL])?|(?:&H[0-9A-F]+|&O[0-7]+)[SIL]?|\\d*\\.\\d+(?:E[+\\-]?\\d+)?[FRD]?|#\\s+(?:\\d+[\\-\\/]\\d+[\\-\\/]\\d+(?:\\s+\\d+:\\d+(?::\\d+)?(\\s*(?:AM|PM))?)?|\\d+:\\d+(?::\\d+)?(\\s*(?:AM|PM))?)\\s+#)", 'i' )],
         ...
         [PR_PLAIN, RegExpProxy( "^(?:(?:[a-z]|_\\w)\\w*(?:\\[[%&@!#]+\\])?|\\[(?:[a-z]|_\\w)\\w*\\])", 'i' )],
